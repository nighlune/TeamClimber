...
local function newButtonHandler(self, event)
	...
	--print("inside ui:newButtonHandler")
...
function newButton(params)
	...
	function button:setText(newText)
		...
		if (params.emboss) then
			...
			labelHighlight.y = labelHighlight.y + 1.5 + offset
			...
			labelHighlight.xScale = .5
			labelHighlight.yScale = .5
			labelShadow.xScale = .5
			labelShadow.yScale = .5
		end
...
function newLabel(params)
	...
	if (params.bounds) then
		...
		--public methods
		function labelGroup:setText(newText)
			if (newText) then
		...
		function labelGroup:setTextColor(r, g, b, a)
			local newR = 255
			local newG = 255
			local newB = 255
			local newA = 255
